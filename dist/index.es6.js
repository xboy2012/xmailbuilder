...
var CONTAINER_DOUBLE = {
    properties: [
        {name: 'bgColor', type: 'string'},
        {name: 'leftWidth', type: 'string'},
        {name: 'rightWidth', type: 'string'},
        {name: 'childNodesLeft', type: 'nodes'},
        {name: 'childNodesRight', type: 'nodes'}
    ]
};
...
var config = {MAIN,IMG_CONTENT,TITLE_CONTENT,BOTTOM_QR,SIGNATURE,IMG,IMG_LINK,CONTAINER,CONTAINER_DOUBLE,TEXT,HTML,BLANK,LIST,LIST_ITEM};
